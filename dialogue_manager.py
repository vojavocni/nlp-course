...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        thread_ids = thread_ids.values

        # HINT: you have already implemented a similar routine in the 3rd assignment.
        
        question_vec = question_to_vec(question, self.word_embeddings, self.embeddings_dim) #### YOUR CODE HERE ####
        best_thread = pairwise_distances_argmin(question_vec[np.newaxis, :], thread_embeddings, metric='cosine')[0]#### YOUR CODE HERE ####
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        #### YOUR CODE HERE ####
        ########################
        chatbot = ChatBot('boring-chitchat-guy')

        # Training the chit-chat guy.
